...
{
    public class PostgreSQLServiceBase<TEntity> : IPostgreSQLServiceBase<TEntity> where TEntity : class
    {
        private readonly IPostgreSQLRepositoryBase<TEntity> _repository;

        public PostgreSQLServiceBase(IPostgreSQLRepositoryBase<TEntity> repository)
        {
